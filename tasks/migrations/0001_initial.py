    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_manager', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='managed_projects', to='users.etmsuser')),
                ('team_members', models.ManyToManyField(blank=True, related_name='assigned_projects', to='users.etmsuser')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('assigned_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.etmsuser')),
